...
export async function exportTransactionsCsv(
  ...
  return invoke("export_transactions_csv", { dateFrom, dateTo, clientId });
}
...
export async function exportReportCsv(
  ...
  return invoke("export_report_csv", { reportType, dateFrom, dateTo, clientId });
}
...
export async function handleExportReport(
  ...
  const csv = await exportReportCsv(reportType, dateFrom, dateTo, clientId);
