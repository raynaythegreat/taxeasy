...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::unlock::verify_pin,
            commands::clients::list_clients,
            commands::clients::create_client,
            commands::clients::bulk_import_client_folders,
            commands::clients::resync_client_folder,
            ...
            commands::updater::rebuild_and_restart,
